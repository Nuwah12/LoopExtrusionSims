...
def main():
    ...
    B3_blockingRegion_forward = np.arange(576+front_buffer, 578+front_buffer) # B3+, EBF1 involved (8, WEAK)
    ...
    ###########################################################################
    blockingRegions = {'E1_1':E1_blockingRegion_1, 'E1_2':E1_blockingRegion_2, 'E2':E2_blockingRegion, 'B3': B3_blockingRegion_forward, 'MYC':MYC_blockingRegion}
